...
#ifndef GDDCPARSER_UNIQUEIDALLOCATOR_H
#define GDDCPARSER_UNIQUEIDALLOCATOR_H
 ...
 * Schuyler.
 */
class UniqueIdAllocator : public godot::RefCounted
{
    GDCLASS( UniqueIdAllocator, godot::RefCounted )
public:
    UniqueIdAllocator();
    ~UniqueIdAllocator();
    ...
    void set_range( uint32_t min = 0, uint32_t max = 20 );
...
#endif // GDDCPARSER_UNIQUEIDALLOCATOR_H
